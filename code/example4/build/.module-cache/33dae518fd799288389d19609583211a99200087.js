var ResultsTable = React.createClass({displayName: "ResultsTable",
    ...
    componentDidMount: function() {
        console.log(this.state.year, ' with key ');
        this.style = {
            color: this.legendColors.black
        };
    ...
    render: function() {
        return (
            React.createElement("p", {
                ...
                style: this.style
                }, React.createElement("strong", null, this.state.year), " reported ", React.createElement("em", null, "$", this.state.amount), ". ", this.props.children.id, " ", this.props.index)
            );
    }
});
